...
**Windows**:框架 334 个测试、FFI 15 个、flutter_gallery 21 个、相册 60 个
...
标题栏在状态栏之下、卡片有阴影、富文本三种样式同段渲染正确;flutter_gallery
滑动 → 打开 demo → 返回后截图与滑动后**逐字节相同**(列表位置保住);
`platform_channels` **PASS**;相册 240 张图甩动后连续三帧都在变;相册双击照片
