...
impl Component for Stage {
    fn build(&self, context: &mut BuildContext) -> AnyWidget {
        ...
        let content: AnyWidget = match self.demo.slug {
            ...
            "buttons" => buttons(state, pressed, handle),
            "cards" => cards(),
            "chips" => chips(state, handle),
            "data-table" => data_table(),
            "dialogs" => dialog_launcher(state, pressed, handle),
            "dividers" => dividers(),
            "grid-lists" => grid_lists(),
            "lists" => lists(),
            "navigation-rail" => navigation_rail(state, pressed, handle),
            "progress" => progress(state, context),
            ...
            "tooltips" => tooltips(state, handle),
